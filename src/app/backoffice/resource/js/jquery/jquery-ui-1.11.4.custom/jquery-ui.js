...
function Datepicker() {
	...
	//추가 2015.07.06 신승현
    this.regional['ko'] = { // Default regional settings
        ...
        showAnim: 'show',
        buttonImage: '../resource/images/common/ic_calendar_w.png',
        buttonText: '달력',
	...
	if ($.cookie("language") != undefined){
		var tempLang = $.cookie("language").split("_");
		$.extend(this._defaults, this.regional[tempLang[0]]);
	} else {
		$.extend(this._defaults, this.regional["ko"]);
	}
