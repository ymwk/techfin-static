...
(function ($) {
    ...
    $.fn.uploadFile = function (options) {
        ...
        var s = $.extend({
            ...
            // uploadStr: "Upload",
            //region 2018.01.30 추가
            dragDropStr: "<span style='font-size:13px;color:#4a4a4a'>파일을 여기로 드랙 하거나,<br>파일찾기/스토리지에서 찾기를 눌러서 첨부하세요</span>",
            uploadStr: '<button id=\"btnWehagoAjaxFileUpload\" type=\"button\" class=\"LUX_basic_btn Image\" style=\"width:inherit\"><span class=\"sp_lux\" style=\"width: 59px; height: 59px; background-position: 0 -307px\">파일업로드</span></button><button type="button" class="LUX_basic_btn Image" style="width:inherit" onclick="javascript:alert(\'스토리지 업로드는 개발중입니다.\');"><span class="sp_lux" style="width: 59px; height: 59px; background-position: -68px -307px">스토리지에서찾기</span></button>',
            //endregion
            abortStr: "Abort",
            cancelStr: "Cancel",
            deleteStr: "Delete",
        ...
        (function checkAjaxFormLoaded() {
            if($.fn.ajaxForm) {
                ...
                //region 2018.01.31 추가 @author 김범진A
                    obj.container = $("<div class='ajax-file-upload-container attachments_list'><ul></ul></div>").insertAfter($(obj));
                //endregion
        ...
        function serializeAndUploadFiles(s, obj, files) {
            for(var i = 0; i < files.length; i++) {
                ...
                pd.filename.html(fileNameStr);
                //region 2018.01.31 추가 @author 김범진A
                // customProgressBar를 이용해서는 플랫폼관리자 업로드 부분의 html 구조상 다운로드 버튼의 삽입이 어려워서 추가함.
                // if(s.showDownload) {
                //     pd.download.appendTo(pd.filename);
                // }
                //endregion
        ...
        function createCustomInputFile (obj, group, s, uploadLabel) {
            ...
            if(s.nestedForms) {
                ...
                //region 2018.01.30 추가
                // 업로드 위치 수정
                form.appendTo($("#btnWehagoAjaxFileUpload"));
                //endregion
        ...
        function createProgressDiv(obj, s) {
            ...
            //region 2018.01.31 추가 @author 김범진A
                $(obj.container).find("ul").append(bar.statusbar);
            //endregion
                // $(obj.container).append(bar.statusbar);
            else
            //region 2018.01.31 추가 @author 김범진A
                $(obj.container).find("ul").prepend(bar.statusbar);
            //endregion
