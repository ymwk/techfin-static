...
(function($){
	...
	$.fn.mSlidebox=function(options){
		var defaults={ //default options
			...
			controlsPosition:{buttonsPosition:"inside",thumbsPosition:"inside"}, //inside/outside/none - 2013.05.02 none 추가 
		...
		return this.each(function(){
			...
			if(slideboxSlide.length>1){ //if more than 1 slides
				...
				}else if(options.controlsPosition.buttonsPosition=="none"){
					// none 추가 - 생성하고 싶지 않을경우
				}else{
				...
				}else if(options.controlsPosition.thumbsPosition=="none"){
					// none 추가 - 생성하고 싶지 않을경우
				}else{
